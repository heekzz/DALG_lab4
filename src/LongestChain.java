...
class LongestChain
{
	...
	public static boolean isNeighbor(String a, String b) throws Exception {
		if(!(a.length() == b.length())) {
			throw new Exception("Strängarnas längd matchar inte!");
		}
		int differ = 0;
	...
	public void CheckAllStartWords(String endWord)
	{
		...
		//		while(keys.hasNext()) {
		//			WordRec x = BreadthFirst(WordList.WordAt(keys.next()), endWord);
		//			if(x != null) {
